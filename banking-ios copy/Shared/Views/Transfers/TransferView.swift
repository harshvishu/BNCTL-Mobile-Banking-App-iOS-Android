                        ...
                        Button {
                            if transferModel.formValidation() {
                                ...
                                if let tr = try? transferModel.getTransfer() {
                                    Task {
                                        do {
                                            let (transferResponse, isEoD) = try await transfersDashboard.validateTransfer(transfer: tr)
                                            ...
                                            default:
                                                transfer = tr
                                                isShownValidationScreen = isEoD == false
                                                break
                                            }
                                            
                                            if(isEoD && transferModel.formErrors.isEmpty) {
                                                transferModel.formErrors["confirm"] = "transfer_end_of_day"
                                            }
                                            
                                        } catch {
                                            transferModel.formErrors["alert"] = "data error"
                                        }
                                    }
                                } else {
                                    transfer = nil
